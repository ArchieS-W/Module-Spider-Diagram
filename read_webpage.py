...
def main_page_urls():
    ...
    # Example webpage containing module details
...
for url in urls:
    ...
    module_title_data = get_module_title(soup)
    if module_prerequisites_data is not None:
        df = df.append({'URL': module_title_data, 'Module Prerequisites': module_prerequisites_data}, ignore_index=True)
